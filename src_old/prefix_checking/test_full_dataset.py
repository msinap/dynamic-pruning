...
def main():
    print("Loading filtered dataset from /workspace/xlam-function-calling-60k-filtered...")
    
    # Load the filtered dataset
    try:
        dataset = load_from_disk("/workspace/xlam-function-calling-60k-filtered")
        print(f"Filtered dataset loaded successfully! Total samples: {len(dataset)}")
    except Exception as e:
